...
import { useRef as P, useState as g, useEffect as R } from "react";
const N = (l) => {
  switch (l) {
    case "secondary":
      return "bg-gray-300 ";
...
}, B = ({ element: l, onClose: a }) => /* @__PURE__ */ n("div", { className: "bg-gray-200 text-gray-600 rounded-full px-3 flex flex-nowrap items-center", children: [
